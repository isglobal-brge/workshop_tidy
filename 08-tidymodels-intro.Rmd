...
ggplot(fold_viz, aes(x = id, y = 1, fill = Fold)) +
...
cv_comparison <- tibble(
  strategy = c("5-Fold", "10-Fold", "LOO", "Bootstrap"),
  cv_object = list(
    vfold_cv(penguin_train, v = 5),
    vfold_cv(penguin_train, v = 10),
    loo_cv(penguin_train),
...
In [Chapter 9](09-data-splitting.qmd), we'll dive deep into data splitting strategies and resampling techniques with rsample.
