...
support_tickets <- tibble(
  ...
  resolved_at = created_at + hours(rexp(n_tickets, rate = 1/24))  # Exponential resolution time
) %>%
  mutate(
...
In [Chapter 8](08-tidymodels-intro.qmd), we transition to machine learning with tidymodels, building on our data manipulation skills.
