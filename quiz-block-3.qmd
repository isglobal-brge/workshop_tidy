...
<div class="quiz-container">
  ...
  <div class="question" data-question="1">
    ...
    <ul class="options">
      <li class="option" data-answer="a">Linear function</li>
      <li class="option" data-answer="b">Sigmoid (logistic) function</li>
      <li class="option" data-answer="c">Exponential function</li>
      <li class="option" data-answer="d">Square root function</li>
    </ul>
  ...
  <div class="question" data-question="3">
    ...
    <ul class="options">
      <li class="option" data-answer="a">To increase model complexity</li>
      <li class="option" data-answer="b">To prevent overfitting by penalizing large coefficients</li>
      <li class="option" data-answer="c">To speed up training</li>
      <li class="option" data-answer="d">To handle missing values</li>
    </ul>
  ...
  <div class="question" data-question="4">
    ...
    <ul class="options">
      <li class="option" data-answer="a">Ridge uses L2 penalty, Lasso uses L1 penalty</li>
      <li class="option" data-answer="b">Ridge is for classification, Lasso is for regression</li>
      <li class="option" data-answer="c">Ridge is faster, Lasso is more accurate</li>
      <li class="option" data-answer="d">They are identical methods</li>
    </ul>
  ...
  <div class="question" data-question="6">
    ...
    <ul class="options">
      <li class="option" data-answer="a">Bagging trains models in parallel, boosting trains them sequentially</li>
      <li class="option" data-answer="b">Bagging is for regression, boosting is for classification</li>
      <li class="option" data-answer="c">Bagging uses decision trees, boosting uses linear models</li>
      <li class="option" data-answer="d">There is no difference</li>
    </ul>
  ...
  <div class="question" data-question="7">
    ...
    <ul class="options">
      <li class="option" data-answer="a">To predict class labels for new data</li>
      <li class="option" data-answer="b">To minimize within-cluster variance</li>
      <li class="option" data-answer="c">To maximize between-cluster variance</li>
      <li class="option" data-answer="d">To reduce the number of features</li>
    </ul>
  ...
  <div class="question" data-question="8">
    ...
    <ul class="options">
      <li class="option" data-answer="a">To improve algorithm speed</li>
      <li class="option" data-answer="b">K-means uses distance measures that can be dominated by variables with large scales</li>
      <li class="option" data-answer="c">To reduce memory usage</li>
      <li class="option" data-answer="d">Scaling is not necessary for K-means</li>
    </ul>
  ...
  <div class="question" data-question="9">
    ...
    <ul class="options">
      ...
      <li class="option" data-answer="b">It reduces dimensionality while preserving variance</li>
      <li class="option" data-answer="c">It handles missing values in datasets</li>
      <li class="option" data-answer="d">It improves classification accuracy</li>
    </ul>
  ...
  <div class="question" data-question="10">
    ...
    <ul class="options">
      <li class="option" data-answer="a">Choosing the optimal number of clusters</li>
      <li class="option" data-answer="b">Selecting the best clustering algorithm</li>
      <li class="option" data-answer="c">Determining outliers in the data</li>
      <li class="option" data-answer="d">Scaling the features appropriately</li>
    </ul>
  ...
  <div class="question" data-question="11">
    ...
    <ul class="options">
      <li class="option" data-answer="a">Training multiple models with identical parameters</li>
      <li class="option" data-answer="b">Using a meta-model to combine predictions from multiple base models</li>
      <li class="option" data-answer="c">Storing models in a hierarchical structure</li>
      <li class="option" data-answer="d">Training models on different datasets</li>
    </ul>
  ...
  <div class="question" data-question="12">
    ...
    <ul class="options">
      <li class="option" data-answer="a">Models always perform worse in production</li>
      <li class="option" data-answer="b">Ensuring reliability, scalability, and maintainability</li>
      <li class="option" data-answer="c">Production environments don't support R</li>
      <li class="option" data-answer="d">Models become obsolete immediately</li>
    </ul>
  ...
  <div class="question" data-question="13">
    ...
    <ul class="options">
      <li class="option" data-answer="a">To fix data pipeline errors</li>
      <li class="option" data-answer="b">To create REST APIs from R functions</li>
      <li class="option" data-answer="c">To deploy Shiny applications</li>
      <li class="option" data-answer="d">To manage package dependencies</li>
    </ul>
  ...
  <div class="question" data-question="14">
    ...
    <ul class="options">
      <li class="option" data-answer="a">It makes models run faster</li>
      <li class="option" data-answer="b">It ensures consistent environments across development and production</li>
      <li class="option" data-answer="c">It automatically tunes hyperparameters</li>
      <li class="option" data-answer="d">It improves model accuracy</li>
    </ul>
...
const questions = {
  1: {
    correct: 'b',
    explanations: {
      a: 'Incorrect. Linear functions cannot constrain outputs to the [0,1] probability range.',
      b: 'Correct! The sigmoid (logistic) function maps any real number to a value between 0 and 1, making it perfect for probabilities.',
      c: 'Incorrect. The exponential function grows without bound and is not suitable for probabilities.',
      d: 'Incorrect. The square root function does not have the right range or properties for probability modeling.'
    }
  },
  2: {
    correct: 'b',
  ...
  3: {
    correct: 'b',
    explanations: {
      a: 'Incorrect. Regularization actually reduces model complexity by constraining parameters.',
      b: 'Correct! Regularization adds a penalty term to prevent overfitting by discouraging large coefficient values.',
      c: 'Incorrect. Regularization may actually slow training slightly but the main purpose is preventing overfitting.',
      d: 'Incorrect. Regularization does not handle missing values; that is done during preprocessing.'
    }
  },
  4: {
    correct: 'a',
    explanations: {
      a: 'Correct! Ridge uses L2 penalty (sum of squared coefficients), Lasso uses L1 penalty (sum of absolute values).',
      b: 'Incorrect. Both Ridge and Lasso can be used for classification and regression.',
      c: 'Incorrect. Speed and accuracy differences depend on the specific problem and implementation.',
      d: 'Incorrect. Ridge and Lasso use different penalty functions with different properties.'
    }
  },
  5: {
    correct: 'b',
  ...
  6: {
    correct: 'a',
    explanations: {
      a: 'Correct! Bagging trains models independently in parallel, while boosting trains them sequentially, each learning from previous mistakes.',
      b: 'Incorrect. Both can be used for classification and regression.',
      c: 'Incorrect. Both can use various types of base models, not restricted to specific algorithms.',
      d: 'Incorrect. Bagging and boosting are fundamentally different ensemble approaches.'
    }
  },
  7: {
    correct: 'b',
    explanations: {
      a: 'Incorrect. K-means is unsupervised and does not predict class labels for new data.',
      b: 'Correct! K-means aims to minimize the within-cluster sum of squares (variance).',
      ...
      d: 'Incorrect. Feature reduction is the goal of dimensionality reduction techniques like PCA, not K-means.'
    }
  },
  8: {
    correct: 'b',
    explanations: {
      a: 'Incorrect. Scaling may slightly affect speed but that is not the main reason.',
      b: 'Correct! K-means uses distance measures, so variables with larger scales can dominate the clustering if not scaled.',
      c: 'Incorrect. Scaling does not significantly affect memory usage.',
      d: 'Incorrect. Scaling is crucial for distance-based algorithms like K-means.'
    }
  },
  9: {
    correct: 'b',
    explanations: {
      ...
      b: 'Correct! PCA finds linear combinations of variables that capture maximum variance while reducing dimensions.',
      c: 'Incorrect. PCA does not handle missing values; preprocessing is needed beforehand.',
      d: 'Incorrect. PCA is primarily for dimensionality reduction, not directly for improving classification accuracy.'
    }
  },
  10: {
    correct: 'a',
    explanations: {
      a: 'Correct! The elbow method plots within-cluster sum of squares vs number of clusters to find the optimal K.',
      b: 'Incorrect. The elbow method is specifically for choosing the number of clusters, not the algorithm.',
      c: 'Incorrect. Outlier detection uses different methods, not the elbow method.',
      d: 'Incorrect. Feature scaling is a preprocessing step, not related to the elbow method.'
    }
  },
  11: {
    correct: 'b',
    explanations: {
      a: 'Incorrect. Model stacking uses diverse models with different parameters.',
      b: 'Correct! Stacking uses a meta-model (often called a blender) to learn how to best combine predictions from multiple base models.',
      c: 'Incorrect. Stacking refers to the prediction combination strategy, not storage structure.',
      d: 'Incorrect. While models may be trained on different datasets, stacking specifically refers to the meta-model approach.'
    }
  },
  12: {
    correct: 'b',
    explanations: {
      a: 'Incorrect. Models can perform well in production with proper implementation.',
      b: 'Correct! Production systems require reliability (24/7 operation), scalability (handling load), and maintainability (updates and monitoring).',
      c: 'Incorrect. Many production environments support R through various deployment options.',
      d: 'Incorrect. Well-designed models can remain useful for extended periods with proper monitoring and maintenance.'
    }
  },
  13: {
    correct: 'b',
    explanations: {
      a: 'Incorrect. Plumber does not fix pipeline errors; it creates web APIs.',
      b: 'Correct! Plumber allows you to create REST APIs from R functions using special comments and decorators.',
      c: 'Incorrect. Shiny applications are deployed using different tools, not plumber.',
      d: 'Incorrect. Package dependency management is handled by tools like renv, not plumber.'
    }
  },
  14: {
    correct: 'b',
    explanations: {
      a: 'Incorrect. Docker does not inherently make models run faster.',
      b: 'Correct! Docker containers package the application and all its dependencies, ensuring consistent environments across different systems.',
      c: 'Incorrect. Docker is for deployment consistency, not hyperparameter tuning.',
      d: 'Incorrect. Docker affects deployment, not the statistical accuracy of models.'
    }
  },
  15: {
    correct: 'a',
