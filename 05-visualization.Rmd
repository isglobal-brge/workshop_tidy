...
In [Chapter 6](06-functional-programming.qmd), we'll explore functional programming with purrr, learning to apply functions efficiently across data structures.
