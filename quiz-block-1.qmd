...
<div class="quiz-container">
  ...
  <div class="question" data-question="6">
    ...
    <ul class="options">
      <li class="option" data-answer="a">import_csv() with type specifications</li>
      <li class="option" data-answer="b">load_csv() with custom parameters</li>
      <li class="option" data-answer="c">read_csv() with the col_types argument</li>
      <li class="option" data-answer="d">read.csv() with stringsAsFactors = FALSE</li>
    </ul>
  ...
  <div class="question" data-question="7">
    ...
    <ul class="options">
      <li class="option" data-answer="a">Returns the same type as the input</li>
      <li class="option" data-answer="b">Always returns a vector</li>
      <li class="option" data-answer="c">Always returns a data frame</li>
      <li class="option" data-answer="d">Always returns a list</li>
    </ul>
  ...
  <div class="question" data-question="10">
    ...
    <ul class="options">
      <li class="option" data-answer="a">Tibbles provide better printing, preserve data types, and have stricter subset behavior</li>
      <li class="option" data-answer="b">Tibbles automatically remove missing values</li>
      <li class="option" data-answer="c">Tibbles can only contain numeric data</li>
      <li class="option" data-answer="d">Tibbles are faster for large datasets</li>
    </ul>
  ...
  <div class="question" data-question="12">
    ...
    <ul class="options">
      <li class="option" data-answer="a">date_year()</li>
      <li class="option" data-answer="b">extract_year()</li>
      <li class="option" data-answer="c">year()</li>
      <li class="option" data-answer="d">get_year()</li>
    </ul>
  ...
  <div class="question" data-question="14">
    ...
    <ul class="options">
      <li class="option" data-answer="a">split_plot()</li>
      <li class="option" data-answer="b">group_plot()</li>
      <li class="option" data-answer="c">facet_wrap() or facet_grid()</li>
      <li class="option" data-answer="d">geom_subplot()</li>
    </ul>
...
const questions = {
  ...
  6: {
    correct: 'c',
    explanations: {
      a: 'Incorrect. import_csv() is not a readr function.',
      b: 'Incorrect. load_csv() is not a readr function.',
      c: 'Correct! read_csv() with col_types allows you to specify custom column types.',
      d: 'Incorrect. read.csv() is base R, and this question asks about readr functions.'
    }
  },
  7: {
    correct: 'd',
    explanations: {
      a: 'Incorrect. map() always returns a list regardless of input type.',
      b: 'Incorrect. map() always returns a list, not a vector.',
      c: 'Incorrect. map() returns a list, not a data frame.',
      d: 'Correct! The basic map() function always returns a list.'
    }
  },
  8: {
    correct: 'b',
  ...
  10: {
    correct: 'a',
    explanations: {
      a: 'Correct! Tibbles offer better printing, preserve column types, and have stricter subsetting behavior.',
      b: 'Incorrect. Tibbles don\'t automatically remove missing values.',
      c: 'Incorrect. Tibbles can contain any data type.',
      d: 'Incorrect. Speed is not the main advantage.'
    }
  },
  11: {
    correct: 'd',
  ...
  12: {
    correct: 'c',
    explanations: {
      a: 'Incorrect. date_year() is not a lubridate function.',
      b: 'Incorrect. extract_year() is not a lubridate function.',
      c: 'Correct! year() extracts the year component from a date.',
      d: 'Incorrect. get_year() is not a lubridate function.'
    }
  },
  13: {
    correct: 'a',
  ...
  14: {
    correct: 'c',
    explanations: {
      a: 'Incorrect. split_plot() is not a ggplot2 function.',
      b: 'Incorrect. group_plot() is not a ggplot2 function.',
      c: 'Correct! facet_wrap() and facet_grid() create subplots based on categorical variables.',
      d: 'Incorrect. geom_subplot() is not a ggplot2 function.'
    }
  },
  15: {
    correct: 'b',
